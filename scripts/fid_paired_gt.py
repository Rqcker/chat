...
def cmd_build(args) -> None:
    ...
    if allf.shape[0] < 10000:
        print(f"NOTE: {allf.shape[0]} reference frames. Jayasumana et al. (CVPR 2024) put the "
              "threshold for a stable 2048-d covariance above 20,000, so this absolute value "
              "is inflated. Quote the distance above the real-video floor, not the absolute.")
