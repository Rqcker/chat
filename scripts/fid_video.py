...
def main() -> None:
    ...
    print("NOTE: the paper target was measured on 1000 dialogues. At this scale the")
    print("      identity-coverage term dominates and 17.33 is unreachable; see DOCS.md.")
